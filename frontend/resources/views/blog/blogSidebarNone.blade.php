                                ...
                                <div class="bp__info-wrap">
                                    <div class="bp__stat">
                                        ...
                                        <span class="bp__stat-wrap">
                                            ...
                                            <span class="bp__author">
                                                ...
                                                <a href="{{ route('blog.SidebarNone') }}">Dayle</a></span></span>
                                        ...
                                        <span class="bp__stat-wrap">
                                            ...
                                            <span class="bp__category">
                                                ...
                                                <a href="{{ route('blog.SidebarNone') }}">Learning</a>

                                                <a href="{{ route('blog.SidebarNone') }}">News</a>

                                                <a href="{{ route('blog.SidebarNone') }}">Health</a></span></span>
                                    </div>
                                    ...
                                    <div class="blog-t-w">
                                        ...
                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.SidebarNone') }}">Travel</a>

                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.SidebarNone') }}">Culture</a>

                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.SidebarNone') }}">Place</a>
                                    </div>
                            ...
                            <div class="bp__wrap">
                                ...
                                <div class="bp__info-wrap">
                                    <div class="bp__stat">
                                        ...
                                        <span class="bp__stat-wrap">
                                            ...
                                            <span class="bp__author">
                                                ...
                                                <a href="{{ route('blog.SidebarNone') }}">Admin</a></span></span>
                                        ...
                                        <span class="bp__stat-wrap">
                                            ...
                                            <span class="bp__category">
                                                ...
                                                <a href="{{ route('blog.SidebarNone') }}">Drawing</a>

                                                <a href="{{ route('blog.SidebarNone') }}">Design</a>

                                                <a href="{{ route('blog.SidebarNone') }}">Illustrator</a></span></span>
                                    </div>
                                    ...
                                    <div class="blog-t-w">
                                        ...
                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.SidebarNone') }}">Creativity</a>

                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.SidebarNone') }}">Art</a>

                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.SidebarNone') }}">Design</a>
                                    </div>
                                    <p class="bp__p">Lorem Ipsum is simply dummy text of the printing and typesetting
                                        industry. Lorem Ipsum has been the industry's standard dummy text.</p>
                                    <div class="gl-l-r">
                            ...
                            <div class="bp__wrap">
                                ...
                                <div class="bp__info-wrap">
                                    <div class="bp__stat">
                                        ...
                                        <span class="bp__stat-wrap">
                                            ...
                                            <span class="bp__author">
                                                ...
                                                <a href="{{ route('blog.SidebarNone') }}">John</a></span></span>
                                        ...
                                        <span class="bp__stat-wrap">
                                            ...
                                            <span class="bp__category">
                                                ...
                                                <a href="{{ route('blog.SidebarNone') }}">Soundcloud</a>

                                                <a href="{{ route('blog.SidebarNone') }}">Lyrics</a></span></span>
                                    </div>
                                    ...
                                    <div class="blog-t-w">
                                        ...
                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.SidebarNone') }}">EDM</a>

                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.SidebarNone') }}">Trance</a>
                                    </div>
                                    <p class="bp__p">Lorem Ipsum is simply dummy text of the printing and typesetting
                                        industry. Lorem Ipsum has been the industry's standard dummy text.</p>
                                    <div class="gl-l-r">
                            ...
                            <div class="bp__wrap">
                                ...
                                <div class="bp__info-wrap">
                                    <div class="bp__stat">
                                        ...
                                        <span class="bp__stat-wrap">
                                            ...
                                            <span class="bp__author">
                                                ...
                                                <a href="{{ route('blog.SidebarNone') }}">Doe</a></span></span>
                                        ...
                                        <span class="bp__stat-wrap">
                                            ...
                                            <span class="bp__category">
                                                ...
                                                <a href="{{ route('blog.SidebarNone') }}">Genre</a>

                                                <a href="{{ route('blog.SidebarNone') }}">Song</a></span></span>
                                    </div>
                                    ...
                                    <div class="blog-t-w">
                                        ...
                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.SidebarNone') }}">Pop</a>
                                    </div>
                                    <p class="bp__p">Lorem Ipsum is simply dummy text of the printing and typesetting
                                        industry. Lorem Ipsum has been the industry's standard dummy text.</p>
                                    <div class="gl-l-r">
                            ...
                            <div class="bp__wrap">
                                ...
                                <div class="bp__info-wrap">
                                    <div class="bp__stat">
                                        ...
                                        <span class="bp__stat-wrap">
                                            ...
                                            <span class="bp__category">
                                                ...
                                                <a href="{{ route('blog.SidebarNone') }}">Video</a>

                                                <a href="{{ route('blog.SidebarNone') }}">Camera</a></span></span>
                                    </div>
                                    ...
                                    <div class="blog-t-w">
                                        ...
                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.SidebarNone') }}">Camera</a>

                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.SidebarNone') }}">Recording</a>
                                    </div>
                                    <p class="bp__p">Lorem Ipsum is simply dummy text of the printing and typesetting
                                        industry. Lorem Ipsum has been the industry's standard dummy text.</p>
                                    <div class="gl-l-r">
                            ...
                            <div class="bp__wrap">
                                ...
                                <div class="bp__info-wrap">
                                    <div class="bp__stat">
                                        ...
                                        <span class="bp__stat-wrap">
                                            ...
                                            <span class="bp__category">
                                                ...
                                                <a href="{{ route('blog.SidebarNone') }}">Youtube</a>

                                                <a href="{{ route('blog.SidebarNone') }}">Videos</a></span></span>
                                    </div>
                                    ...
                                    <div class="blog-t-w">
                                        ...
                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.SidebarNone') }}">Freetime</a>
                                    </div>
                                    <p class="bp__p">Lorem Ipsum is simply dummy text of the printing and typesetting
                                        industry. Lorem Ipsum has been the industry's standard dummy text.</p>
                                    <div class="gl-l-r">
