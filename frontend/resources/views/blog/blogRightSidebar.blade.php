                            ...
                            <div class="bp__wrap">
                                ...
                                <div class="bp__info-wrap">
                                    <div class="bp__stat">
                                        ...
                                        <span class="bp__stat-wrap">
                                            ...
                                            <span class="bp__author">
                                                ...
                                                <a href="{{ route('blog.RightSidebar') }}">Admin</a></span></span>
                                        ...
                                        <span class="bp__stat-wrap">
                                            ...
                                            <span class="bp__category">
                                                ...
                                                <a href="{{ route('blog.RightSidebar') }}">Drawing</a>

                                                <a href="{{ route('blog.RightSidebar') }}">Design</a>

                                                <a href="{{ route('blog.RightSidebar') }}">Illustrator</a></span></span>
                                    </div>
                                    ...
                                    <div class="blog-t-w">
                                        ...
                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.RightSidebar') }}">Creativity</a>

                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.RightSidebar') }}">Art</a>

                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.RightSidebar') }}">Design</a>
                                    </div>
                                    <p class="bp__p">Lorem Ipsum is simply dummy text of the printing and typesetting
                                        industry. Lorem Ipsum has been the industry's standard dummy text.</p>
                                    <div class="gl-l-r">
                            ...
                            <div class="bp__wrap">
                                ...
                                <div class="bp__info-wrap">
                                    <div class="bp__stat">
                                        ...
                                        <span class="bp__stat-wrap">
                                            ...
                                            <span class="bp__author">
                                                ...
                                                <a href="{{ route('blog.RightSidebar') }}">John</a></span></span>
                                        ...
                                        <span class="bp__stat-wrap">
                                            ...
                                            <span class="bp__category">
                                                ...
                                                <a href="{{ route('blog.RightSidebar') }}">Soundcloud</a>

                                                <a href="{{ route('blog.RightSidebar') }}">Lyrics</a></span></span>
                                    </div>
                                    ...
                                    <div class="blog-t-w">
                                        ...
                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.RightSidebar') }}">EDM</a>

                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.RightSidebar') }}">Trance</a>
                                    </div>
                                    <p class="bp__p">Lorem Ipsum is simply dummy text of the printing and typesetting
                                        industry. Lorem Ipsum has been the industry's standard dummy text.</p>
                                    <div class="gl-l-r">
                            ...
                            <div class="bp__wrap">
                                ...
                                <div class="bp__info-wrap">
                                    <div class="bp__stat">
                                        ...
                                        <span class="bp__stat-wrap">
                                            ...
                                            <span class="bp__author">
                                                ...
                                                <a href="{{ route('blog.RightSidebar') }}">Doe</a></span></span>
                                        ...
                                        <span class="bp__stat-wrap">
                                            ...
                                            <span class="bp__category">
                                                ...
                                                <a href="{{ route('blog.RightSidebar') }}">Genre</a>

                                                <a href="{{ route('blog.RightSidebar') }}">Song</a></span></span>
                                    </div>
                                    ...
                                    <div class="blog-t-w">
                                        ...
                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.RightSidebar') }}">Pop</a>
                                    </div>
                                    <p class="bp__p">Lorem Ipsum is simply dummy text of the printing and typesetting
                                        industry. Lorem Ipsum has been the industry's standard dummy text.</p>
                                    <div class="gl-l-r">
                            ...
                            <div class="bp__wrap">
                                ...
                                <div class="bp__info-wrap">
                                    <div class="bp__stat">
                                        ...
                                        <span class="bp__stat-wrap">
                                            ...
                                            <span class="bp__category">
                                                ...
                                                <a href="{{ route('blog.RightSidebar') }}">Video</a>

                                                <a href="{{ route('blog.RightSidebar') }}">Camera</a></span></span>
                                    </div>
                                    ...
                                    <div class="blog-t-w">
                                        ...
                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.RightSidebar') }}">Camera</a>

                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.RightSidebar') }}">Recording</a>
                                    </div>
                                    <p class="bp__p">Lorem Ipsum is simply dummy text of the printing and typesetting
                                        industry. Lorem Ipsum has been the industry's standard dummy text.</p>
                                    <div class="gl-l-r">
                            ...
                            <div class="bp__wrap">
                                ...
                                <div class="bp__info-wrap">
                                    <div class="bp__stat">
                                        ...
                                        <span class="bp__stat-wrap">
                                            ...
                                            <span class="bp__category">
                                                ...
                                                <a href="{{ route('blog.RightSidebar') }}">Youtube</a>

                                                <a href="{{ route('blog.RightSidebar') }}">Videos</a></span></span>
                                    </div>
                                    ...
                                    <div class="blog-t-w">
                                        ...
                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.RightSidebar') }}">Freetime</a>
                                    </div>
                                    <p class="bp__p">Lorem Ipsum is simply dummy text of the printing and typesetting
                                        industry. Lorem Ipsum has been the industry's standard dummy text.</p>
                                    <div class="gl-l-r">
                        ...
                        <nav class="post-center-wrap u-s-p-y-60">
                            ...
                            <ul class="blog-pg">
                                <li class="blog-pg--active">
                                    ...
                                    <a href="{{ route('blog.RightSidebar') }}">1</a>
                                </li>
                                <li>

                                    <a href="{{ route('blog.RightSidebar') }}">2</a>
                                </li>
                                <li>

                                    <a href="{{ route('blog.RightSidebar') }}">3</a>
                                </li>
                                <li>

                                    <a href="{{ route('blog.RightSidebar') }}">4</a>
                                </li>
                                <li>

                                    <a class="fas fa-angle-right" href="{{ route('blog.RightSidebar') }}"></a>
                                </li>
                            </ul>
                            <!--====== End - Pagination ======-->
                        </nav>
                                ...
                                <div class="blog-w">
                                    ...
                                    <ul class="blog-w__list">
                                        <li>
                                            ...
                                            <a href="{{ route('blog.RightSidebar') }}">Corporate</a>
                                        </li>
                                        <li>

                                            <a href="{{ route('blog.RightSidebar') }}">Creative</a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <a href="{{ route('blog.RightSidebar') }}">Photography</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="blog-w">
                                    ...
                                    <ul class="blog-w__list">
                                        <li>
                                            ...
                                            <a href="{{ route('blog.RightSidebar') }}">March 2017 (1)</a>
                                        </li>
                                        <li>

                                            <a href="{{ route('blog.RightSidebar') }}">December 2017 (3)</a>
                                        </li>
                                        <li>

                                            <a href="{{ route('blog.RightSidebar') }}">November 2017 (4)</a>
                                        </li>
                                        <li>

                                            <a href="{{ route('blog.RightSidebar') }}">September 2017 (1)</a>
                                        </li>
                                        <li>

                                            <a href="{{ route('blog.RightSidebar') }}">August 2014 (1)</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="blog-w">
                                    ...
                                    <div class="blog-t-w">
                                        ...
                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.RightSidebar') }}">Dresses</a>

                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.RightSidebar') }}">Shirts & Tops</a>

                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.RightSidebar') }}">Polo Shirts</a>

                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.RightSidebar') }}">Sweaters</a>

                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.RightSidebar') }}">Blazers</a>

                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.RightSidebar') }}">Vests</a>

                                        <a class="gl-tag btn--e-transparent-hover-brand-b-2"
                                            href="{{ route('blog.RightSidebar') }}">Jackets</a>
                                    </div>
                                </div>
                            </div>
                        </div>
