                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="slider-content slider-content--animation">
                                        ...
                                        <a class="shop-now-link btn--e-brand" action="{{ route('shop.side_v2') }}">SHOP NOW</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                            <div class="promotion-o">
                                ...
                                <div class="promotion-o__content">
                                    ...
                                    <a class="promotion-o__link btn--e-white-brand" action="{{ route('shop.side_v2') }}">Women's
                                        Clothing</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                            <div class="promotion-o">
                                ...
                                <div class="promotion-o__content">
                                    ...
                                    <a class="promotion-o__link btn--e-white-brand" action="{{ route('shop.side_v2') }}">Fashion
                                        Accessories</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                            <div class="promotion-o">
                                ...
                                <div class="promotion-o__content">
                                    ...
                                    <a class="promotion-o__link btn--e-white-brand" action="{{ route('shop.side_v2') }}">Men's
                                        Clothing</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 col-md-12">
                                ...
                                <a class="i3-banner" action="{{ route('shop.side_v2') }}">
                                            ...
                                            <div class="product-short__container">
                                                <div class="product-short__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey-fb aspect--square u-d-block"
                                                        ...
                                                        <img class="aspect__img product-short__img"
                                                            src="images/product/women/product14.jpg" alt=""></a>
                                                </div>
                                                <div class="product-short__info">
                                                    ...
                                                    <span class="product-short__name">
                                                        ...
                                                        <a action="{{ route('products.detail') }}"Women Shoes</a></span>
                                            ...
                                            <div class="product-short__container">
                                                <div class="product-short__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey-fb aspect--square u-d-block"
                                                        ...
                                                        <img class="aspect__img product-short__img"
                                                            src="images/product/men/product12.jpg" alt=""></a>
                                                </div>
                                                <div class="product-short__info">
                                                    ...
                                                    <span class="product-short__name">
                                                        ...
                                                        <a action="{{ route('products.detail') }}"Men Leather Wallet</a></span>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 u-s-m-b-30">
                            <div class="product-r u-h-100">
                                <div class="product-r__container">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" action="{{ route('products.detail') }}"
                                    ...
                                    <div class="product-r__action-wrap">
                                        <ul class="product-r__action-list">
                                            ...
                                            <li>
                                                ...
                                                <a action="{{ route('login') }}"><i class="fas fa-heart"></i></a>
                                            </li>
                                            <li>

                                                <a action="{{ route('login') }}"><i class="fas fa-envelope"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="product-r__info-wrap">
                                    ...
                                    <span class="product-r__description">Lorem Ipsum is simply dummy text of the printing
                                        ...
                                        <div class="product-bs">
                                            <div class="product-bs__container">
                                                ...
                                                <span class="product-bs__name">
                                                    ...
                                                    <a action="{{ route('products.detail') }}"Black &amp; White Sweater</a></span>
                                        ...
                                        <div class="product-bs">
                                            <div class="product-bs__container">
                                                ...
                                                <span class="product-bs__name">
                                                    ...
                                                    <a action="{{ route('products.detail') }}"Color Yellow Modest A Fashion</a></span>
                                                <div class="product-bs__rating gl-rating-style"><i
                                                        class="fas fa-star"></i><i class="fas fa-star"></i><i
                                                        class="fas fa-star"></i><i class="fas fa-star"></i><i
                                                        class="far fa-star"></i>
                                        ...
                                        <div class="product-bs">
                                            <div class="product-bs__container">
                                                ...
                                                <span class="product-bs__name">
                                                    ...
                                                    <a action="{{ route('products.detail') }}"White Full Men Underwear</a></span>
                                                <div class="product-bs__rating gl-rating-style"><i
                                                        class="fas fa-star"></i><i class="fas fa-star"></i><i
                                                        class="fas fa-star"></i><i class="fas fa-star"></i><i
                                                        class="far fa-star"></i>
                                        ...
                                        <div class="product-bs">
                                            <div class="product-bs__container">
                                                ...
                                                <span class="product-bs__name">
                                                    ...
                                                    <a action="{{ route('products.detail') }}"Color Yellow Modest B Fashion</a></span>
                                                <div class="product-bs__rating gl-rating-style"><i
                                                        class="fas fa-star"></i><i class="fas fa-star"></i><i
                                                        class="fas fa-star"></i><i class="fas fa-star"></i><i
                                                        class="far fa-star"></i>
                                        ...
                                        <div class="product-bs">
                                            <div class="product-bs__container">
                                                ...
                                                <span class="product-bs__name">
                                                    ...
                                                    <a action="{{ route('products.detail') }}"Blown Sunglasses For Deux</a></span>
                                                <div class="product-bs__rating gl-rating-style"><i
                                                        class="fas fa-star"></i><i class="fas fa-star"></i><i
                                                        class="fas fa-star"></i><i class="fas fa-star"></i><i
                                                        class="far fa-star"></i>
                                        ...
                                        <div class="product-bs">
                                            <div class="product-bs__container">
                                                ...
                                                <span class="product-bs__name">
                                                    ...
                                                    <a action="{{ route('products.detail') }}"Ladies Black Bag</a></span>
                                                <div class="product-bs__rating gl-rating-style"><i
                                                        class="fas fa-star"></i><i class="fas fa-star"></i><i
                                                        class="fas fa-star"></i><i class="fas fa-star"></i><i
                                                        class="far fa-star"></i>
                                        ...
                                        <div class="product-bs">
                                            <div class="product-bs__container">
                                                ...
                                                <span class="product-bs__name">
                                                    ...
                                                    <a action="{{ route('products.detail') }}"Casual Shoes Independence</a></span>
                                                <div class="product-bs__rating gl-rating-style"><i
                                                        class="fas fa-star"></i><i class="fas fa-star"></i><i
                                                        class="fas fa-star"></i><i class="fas fa-star"></i><i
                                                        class="far fa-star"></i>
                                        ...
                                        <div class="product-bs">
                                            <div class="product-bs__container">
                                                ...
                                                <span class="product-bs__name">
                                                    ...
                                                    <a action="{{ route('products.detail') }}"Men Casual Shoes Charcoal</a></span>
                                                <div class="product-bs__rating gl-rating-style"><i
                                                        class="fas fa-star"></i><i class="fas fa-star"></i><i
                                                        class="fas fa-star"></i><i class="fas fa-star"></i><i
                                                        class="far fa-star"></i>
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link"
                                                    ...
                                                    <img class="aspect__img" src="images/product/women/product10.jpg"
                                                        alt=""></a>
                                            </div>
                                            <div class="product-l__info-wrap">
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link"
                                                    ...
                                                    <img class="aspect__img" src="images/product/women/product11.jpg"
                                                        alt=""></a>
                                            </div>
                                            <div class="product-l__info-wrap">
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link"
                                                    ...
                                                    <img class="aspect__img" src="images/product/women/product12.jpg"
                                                        alt=""></a>
                                            </div>
                                            <div class="product-l__info-wrap">
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link"
                                                    ...
                                                    <img class="aspect__img" src="images/product/women/product13.jpg"
                                                        alt=""></a>
                                            </div>
                                            <div class="product-l__info-wrap">
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link"
                                                    ...
                                                    <img class="aspect__img" src="images/product/women/product1.jpg"
                                                        alt=""></a>
                                            </div>
                                            <div class="product-l__info-wrap">
                                                <div class="product-l__rating gl-rating-style"><i class="fas fa-star"></i><i
                                                ...
                                                <span class="product-l__name">
                                                    ...
                                                    <a action="{{ route('products.detail') }}"Women intimate Bra</a></span>
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link"
                                                    ...
                                                    <img class="aspect__img" src="images/product/women/product2.jpg"
                                                        alt=""></a>
                                            </div>
                                            <div class="product-l__info-wrap">
                                                <div class="product-l__rating gl-rating-style"><i class="fas fa-star"></i><i
                                                ...
                                                <span class="product-l__name">
                                                    ...
                                                    <a action="{{ route('products.detail') }}"Women Wedding Event Dress</a></span>
