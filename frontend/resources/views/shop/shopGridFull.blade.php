                            ...
                            <div class="u-s-p-y-60">
                                ...
                                <ul class="shop-p__pagination">
                                    <li class="is-active">
                                        ...
                                        <a href="{{ route('shop.GridFull') }}">1</a>
                                    </li>
                                    <li>

                                        <a href="{{ route('shop.GridFull') }}">2</a>
                                    </li>
                                    <li>

                                        <a href="{{ route('shop.GridFull') }}">3</a>
                                    </li>
                                    <li>

                                        <a href="{{ route('shop.GridFull') }}">4</a>
                                    </li>
                                    <li>
                                        <a class="fas fa-angle-right" href="{{ route('shop.GridFull') }}"></a>
                                    </li>
                                </ul>
                                <!--====== End - Pagination ======-->
                            </div>
