                            ...
                            <div class="u-s-p-y-60">
                                ...
                                <ul class="shop-p__pagination">
                                    <li class="is-active">
                                        ...
                                        <a href="{{ route('shop.ListRight') }}">1</a>
                                    </li>
                                    <li>

                                        <a href="{{ route('shop.ListRight') }}">2</a>
                                    </li>
                                    <li>

                                        <a href="{{ route('shop.ListRight') }}">3</a>
                                    </li>
                                    <li>

                                        <a href="{{ route('shop.ListRight') }}">4</a>
                                    </li>
                                    <li>

                                        <a class="fas fa-angle-right" href="{{ route('shop.ListRight') }}"></a>
                                    </li>
                                </ul>
                                <!--====== End - Pagination ======-->
                            </div>
