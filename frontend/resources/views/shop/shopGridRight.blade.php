                                        ...
                                        <div class="product-m">
                                            ...
                                            <div class="product-m__content">
                                                <div class="product-m__category">
                                                    ...
                                                    <a href="{{ route('shop.side_v2') }}">Men Clothing</a>
                                                </div>
                                        ...
                                        <div class="product-m">
                                            ...
                                            <div class="product-m__content">
                                                <div class="product-m__category">
                                                    ...
                                                    <a href="{{ route('shop.side_v2') }}">Women Clothing</a>
                                                </div>
                                                <div class="product-m__name">
                            ...
                            <div class="u-s-p-y-60">
                                ...
                                <ul class="shop-p__pagination">
                                    <li class="is-active">
                                        ...
                                        <a href="{{ route('shop.GridRight') }}">1</a>
                                    </li>
                                    <li>

                                        <a href="{{ route('shop.GridRight') }}">2</a>
                                    </li>
                                    <li>

                                        <a href="{{ route('shop.GridRight') }}">3</a>
                                    </li>
                                    <li>

                                        <a href="{{ route('shop.GridRight') }}">4</a>
                                    </li>
                                    <li>

                                        <a class="fas fa-angle-right" href="{{ route('shop.GridRight') }}"></a>
                                    </li>
                                </ul>
                                <!--====== End - Pagination ======-->
                            </div>
