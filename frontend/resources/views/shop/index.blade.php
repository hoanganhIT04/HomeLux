                    ...
                    <div class="col-lg-12">
                        <div class="filter-category-container">
                            <div class="filter__category-wrapper">
                                ...
                                <button class="btn filter__btn filter__btn--style-1 js-checked" type="button"
                                    data-filter=".cat-4">Bàn</button>
                            </div>
                            <div class="filter__category-wrapper">

                                <button class="btn filter__btn filter__btn--style-1" type="button"
                                    data-filter=".cat-5">Ghế</button>
                            </div>
                            <div class="filter__category-wrapper">

                                <button class="btn filter__btn filter__btn--style-1" type="button"
                                    data-filter=".cat-6">Sofa</button>
                            </div>
                            <div class="filter__category-wrapper">

                                <button class="btn filter__btn filter__btn--style-1" type="button"
                                    data-filter=".cat-7">Nệm</button>
                            </div>
                            <div class="filter__category-wrapper">

                                <button class="btn filter__btn filter__btn--style-1" type="button"
                                    data-filter=".cat-8">Đèn</button>
                            </div>
                        </div>
                        <div class="filter__grid-wrapper u-s-m-t-30">
                            <div class="row filter__grid">
                                ...
                                @php
                                $cateId = $p['category_id'];

                                // Nếu chưa có biến đếm cho category này → tạo mới
                                if (!isset($countByCate[$cateId])) {
                                $countByCate[$cateId] = 0;
                                }

                                // Nếu category này đã đủ 4 sp → bỏ qua
                                if ($countByCate[$cateId] >= 4) {
                                continue;
                                }
                                ...
                                <!-- Giao diện sản phẩm -->
                                <div
                                    class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30 filter__item cat-{{ $p['category_id'] }}">
    ...
    <div class="product-o__action-wrap">
        <ul class="product-o__action-list">
            <li>
                ...
                <a data-bs-toggle="modal" data-bs-target="#quick-look" data-tooltip="tooltip" data-placement="top"
                    title="Quick View"><i class="fas fa-search-plus"></i></a>
            </li>
            <li>

                <a data-bs-toggle="modal" data-bs-target="#add-to-cart" data-tooltip="tooltip" data-placement="top"
                    title="Add to Cart"><i class="fas fa-plus-circle"></i></a>
            </li>
            <li>

                <a href="{{ route('login') }}" data-tooltip="tooltip" data-placement="top" title="Add to Wishlist"><i
...
<span class="product-o__name">
    ...
    <a href="{{ route('products.detail', $p['id']) }}">DJI Phantom Drone 4k</a></span>
<div class="product-o__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i
...
<div class="col-lg-6 col-md-6 u-s-m-b-30">
    <div class="product-o product-o--radius product-o--hover-off u-h-100">
        <div class="product-o__wrap">
            ...
            <a class="aspect aspect--bg-grey aspect--square u-d-block" href="{{ route('products.detail', $p['id']) }}">
            ...
            <div class="product-o__action-wrap">
                <ul class="product-o__action-list">
                    <li>
                        ...
                        <a data-bs-toggle="modal" data-bs-target="#quick-look" data-tooltip="tooltip"
                            data-placement="top" title="Quick View"><i class="fas fa-search-plus"></i></a>
                    </li>
                    <li>

                        <a data-bs-toggle="modal" data-bs-target="#add-to-cart" data-tooltip="tooltip"
                            data-placement="top" title="Add to Cart"><i class="fas fa-plus-circle"></i></a>
                    </li>
                    <li>
        ...
        <span class="product-o__name">
            ...
            <a href="{{ route('products.detail', $p['id']) }}">DJI Phantom Drone 2k</a></span>
        <div class="product-o__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i
                class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                    ...
                    <div class="u-s-m-b-30">
                        <div class="product-o product-o--hover-on">
                            <div class="product-o__wrap">
                                ...
                                <a class="aspect aspect--bg-grey aspect--square u-d-block"
                                    href="{{ route('products.detail', $p['id']) }}">
                                    <img class="aspect__img" src="{{ $p['primary_image'] }}" alt="{{ $p['name'] }}">
                                </a>
                    ...
                    <div class="product-o product-o--hover-on u-h-100">
                        <div class="product-o__wrap">
                            ...
                            <div class="product-o__action-wrap">
                                <ul class="product-o__action-list">
                                    <li>
                                        <a data-bs-toggle="modal" data-bs-target="#quick-look" title="Quick View"><i
                                                class="fas fa-search-plus"></i></a>
                                    </li>
                                    <li>
                                        <a data-bs-toggle="modal" data-bs-target="#add-to-cart" title="Add to Cart"><i
                                                class="fas fa-plus-circle"></i></a>
                                    </li>
                                    <li>
                                        <a href="{{ route('login') }}" title="Add to Wishlist">
                                            <i class="fas fa-heart"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('login') }}" title="Email me When the price drops">
                        ...
                        <span class="product-o__category">
                            <a href="{{ route('shop.side_v2') }}">
                                {{ $categories[$p['category_id']]['name'] ?? 'Danh mục' }}
                            </a>
                        </span>
...
<div class="product-l__info-wrap">
    ...
    <span class="product-l__name">
        ...
        <a href="{{ route('products.detail', $p['id']) }}">Razor Gear 15 Ram
            16GB</a></span>
    ...
    <div class="product-l">
        ...
        <div class="product-l__info-wrap">
            ...
            <span class="product-l__name">
                ...
                <a href="{{ route('products.detail', $p['id']) }}">Razor Gear 13 Ram
                    16GB</a></span>
                ...
                <div class="product-l">
                    ...
                    <div class="product-l__info-wrap">
                        ...
                        <span class="product-l__name">
                            ...
                            <a href="{{ route('products.detail', $p['id']) }}">Razor Gear 10 Ram
                                16GB</a></span>
                ...
                <div class="product-l">
                    ...
                    <div class="product-l__info-wrap">
                        ...
                        <span class="product-l__name">
                            ...
                            <a href="{{ route('products.detail', $p['id']) }}">Razor Gear 15 Ultra
                                Ram
                                16GB</a></span>
                ...
                <div class="product-l">
                    ...
                    <div class="product-l__info-wrap">
                        ...
                        <span class="product-l__name">
                            ...
                            <a href="{{ route('products.detail', $p['id']) }}">Razor Gear 20 Ultra
                                Ram
                                16GB</a></span>
                ...
                <div class="product-l">
                    ...
                    <div class="product-l__info-wrap">
                        ...
                        <span class="product-l__name">
                            ...
                            <a href="{{ route('products.detail', $p['id']) }}">Razor Gear 11 Ultra
                                Ram
                                16GB</a></span>
                ...
                <div class="product-l">
                    ...
                    <div class="product-l__info-wrap">
                        ...
                        <span class="product-l__name">
                            ...
                            <a href="{{ route('products.detail', $p['id']) }}">Razor Gear 10 Ultra
                                Ram
                                16GB</a></span>
                            ...
                            <div class="u-s-m-b-15">
                                <div class="pd-detail__rating gl-rating-style"><i class="fas fa-star"></i><i
                                    ...
                                    <span class="pd-detail__review u-s-m-l-4">
                                        ...
                                        <a href="{{ route('products.detail', $p['id']) }}">23 Reviews</a></span>
                                </div>
                            </div>
                            <div class="u-s-m-b-15">
                                <div class="pd-detail__inline">
